                  ...
                  <li>
                    ...
                    >
                      <img
                        ...
                        className="lazy-img"
                        style={{color:"transparent"}}
                        src="../../_next/static/media/icon_4_active.7194d627.svg"
                      />
                      <span>Messages</span>
                    </a>
                  </li>
                        ...
                        <div className="email-read-panel">
                          <div className="email-list-item ps-3 pe-3 ps-xxl-4 pe-xxl-4 read">
                            <div className="email-short-preview position-relative">
                              ...
                              <div className="mail-text">
                                Hello, This is Jenny from google. We’r the
                                largest online platform offer...
                              </div>
                          ...
                          <div className="email-list-item ps-3 pe-3 ps-xxl-4 pe-xxl-4 read">
                            <div className="email-short-preview position-relative">
                              ...
                              <div className="mail-text">
                                Hello, We’r the well known Real Estate Inc
                                provide best interior/exterior solut...
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="email-body divider">
                          <div className="ps-4 pe-4 ps-xxl-5 pe-xxl-5">
                            ...
                            <p>
                              ...
                              information. If you have any question don’t
                        ...
                        <div className="email-footer">
                          <div className="ps-4 pe-4 ps-xxl-5 pe-xxl-5">
                            ...
                            <div className="compose-new-email-container">
                              ...
                              <div className="compose-body">
                                <textarea>
                                  Hi, Mary Cooper! Thanks for your invitation
                                  for the account manager position for you
                                  company. I Will back to you soon with all the
                                  require documents.
                                </textarea>
                              </div>
                              <div className="compose-email-footer d-flex justify-content-between">
